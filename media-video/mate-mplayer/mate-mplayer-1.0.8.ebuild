...
# $Header: /var/cvsroot/gentoo-x86/media-video/gnome-mplayer/gnome-mplayer-1.0.8.ebuild,v 1.1 2013/06/03 07:13:20 ssuominen Exp $

EAPI=5
inherit fdo-mime mate-utils

DESCRIPTION="A GTK+ interface to MPlayer - Mate version"
HOMEPAGE="https://github.com/NiceandGently/mate-mplayer"
SRC_URI="https://github.com/NiceandGently/${PN}/archive/v${PV}.tar.gz -> ${P}.tar.gz"

LICENSE="GPL-2"
SLOT="0"
KEYWORDS="~alpha ~amd64 ~ppc ~ppc64 ~x86 ~x86-fbsd"
IUSE="alsa +dbus +dconf gda mate ipod libnotify musicbrainz pulseaudio"
